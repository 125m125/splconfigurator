...
import OrChildGroup from "../../../src/entities/childGroups/OrChildGroup";
import {
    fillChildGroup,
    stubFeature
...
ava("does nothing if feature was selected", test => {
    var uut = new OrChildGroup();
    fillChildGroup(3, uut);
    sinon.stub(uut, "selectLast");
    sinon.stub(uut, "selectAllPositive");
...
ava("selects parent negative if last feature was selected negative", test => {
    ...
    var uut = new OrChildGroup(parent);
    fillChildGroup(3, uut);
